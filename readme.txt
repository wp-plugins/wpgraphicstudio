...
1. The settings page. Set module logo, naviation color,
2. A streamlined members/create graphic area.
3. Members area, module options, view gallery and create graphic options on hover.
4. Graphic galleries options, delet, email, download graphic options on hover.
