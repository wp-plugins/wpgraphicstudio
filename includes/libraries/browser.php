<?php
	 ...
	 *
	 * Modified to work for WPGS by
	 * John Seroka on 07/30/2014
	 * Changes: Removed the browser string return and added spacing. Also removed return HTML formatting.
	 *
	 * Modified to add formatted User Agent string for WPGS System Info by
	 * John Seroka on 07/30/2014
	 * Changes: Split user string and add formatting so we can print a nicely
	 * formatted user agent string on the WPGS System Info
	 *
	 * File: Browser.php
