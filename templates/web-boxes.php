...
?><div margin = "0" align = "center" height = "650px" width = "800px">
<object id="flashcontent" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="800px" height="650px">
<?php echo'<param name="movie" value="'.plugins_url( 'web-boxes.swf', dirname(__FILE__) ).'?logoURL='.$logo.'&NavColor='.$decHex.'" />'; ?>
  <!--[if !IE]>-->
  <?php echo '<object type="application/x-shockwave-flash" data="'.plugins_url( 'web-boxes.swf', dirname(__FILE__) ).'?logoURL='.$logo.'&NavColor='.$decHex.'" width="800px" height="650px">'; ?>
  <!--<![endif]-->
  </div>
    <p>
