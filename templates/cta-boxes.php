...
<div class="isa_success">Your Call toAction Box Graphic Has Been eMailed to the eMail address on file.</div>
<?php
}
}
...
<input class=\"galleryDelete\" type=\"submit\" value=\"\" title=\"Delete Graphic\" alt=\"Delete Graphic\" /></form>
...
<form action=\"/cta-boxes\" id=\"eMail\" method=\"post\">
<input type=\"hidden\" name=\"file\" value=\"$file_name\">
<input type=\"hidden\" name=\"view\" value=\"gallery\">
<input type=\"hidden\" name=\"email\" value=\"1\">
<input class=\"galleryEmail\" type=\"submit\" value=\"\" title=\"Email Graphic\" alt=\"Email Graphic\" /></form>
</div></li>\n";
			}
			else
			{
