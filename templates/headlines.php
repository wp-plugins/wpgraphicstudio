...
Your created Headline Has Been Saved To Your Buttons Graphic Gallery For Future Use.
...
<?php echo'<param name="movie" value="'.plugins_url( 'headlines.swf', dirname(__FILE__) ).'?logoURL='.$logo.'&NavColor='.$nav_hex.'" />'; ?>
  <!--[if !IE]>-->
  <?php echo '<object type="application/x-shockwave-flash" data="'.plugins_url( 'headlines.swf', dirname(__FILE__) ).'?logoURL='.$logo.'&NavColor='.$nav_hex.'" width="900px" height="775px">'; ?>
  <!--<![endif]-->
  </div>
    <p>
