...
<?php echo'<param name="movie" value="'.plugins_url( 'buttons.swf', dirname(__FILE__) ).'?logoURL='.$logo.'&NavColor='.$decHex.'" />'; ?>
  <!--[if !IE]>-->
  <?php echo '<object type="application/x-shockwave-flash" data="'.plugins_url( 'buttons.swf', dirname(__FILE__) ).'?logoURL='.$logo.'&NavColor='.$decHex.'" width="850px" height="650px">'; ?>
  <!--<![endif]-->
  </div>
    <p>
