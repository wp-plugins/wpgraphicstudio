...
function wpgs_wpgraphicstudio_settings_menu() {
	add_submenu_page( 'NULL', __( 'wpGraphicStudio', 'wpgs' ), __( 'wpGraphicStudio', 'wpgs' ), 'administrator', 'core-settings', 'wpgs_wpgraphicstudio_settings_page' );
}
				...
				<tbody>
					<tr valign="top">
						<th scope="row" valign="top">
							<?php _e('Modules Logo URL'); ?>
						</th>
						<td>
							<input id="wpgs_wpgraphicstudio_logo_url" name="wpgs_wpgraphicstudio_logo_url" type="text" class="regular-text" value="<?php echo $logo_url ?>" />
							<label class="description" for="wpgs_wpgraphicstudio_logo_url"><?php _e('Enter the url to your module logo that will appear at the top right of each module'); ?></label>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row" valign="top">
						...
						<td>
							...
							<label class="description" for="wpgs_wpgraphicstudio_nav_hex"><?php _e('Enter the 6 digit hex code for the navigation menu background color'); ?></label>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row" valign="top">
						...
						<td>
							<input id="wpgs_wpgraphicstudio_per_gallery" name="wpgs_wpgraphicstudio_per_gallery" type="text" class="regular-text" value="<?php echo $per_gallery ?>" />
							<label class="description" for="wpgs_wpgraphicstudio_per_gallery"><?php _e('How many graphics to display (per page) in the graphics gallery for each module'); ?></label>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row" valign="top">
						...
						<td>
							<input id="wpgs_wpgraphicstudio_per_members" name="wpgs_wpgraphicstudio_per_members" type="text" class="regular-text" value="<?php echo $per_members ?>" />
							<label class="description" for="wpgs_wpgraphicstudio_per_members"><?php _e('How many modules to display (per page) in the "Create Graphic & "Member Galleries" areas'); ?></label>
						</td>
					</tr>
				</tbody>
			</table>
...
$from = ''.WP_CONTENT_DIR . '/plugins/wp-graphic-studio/includes/wpgs/';
