<?php
/**
 * Plugin Name: wpGraphicStudio Core
 ...
 *
 * wpGraphicStudio is not free software: you can not redistribute it, sell it or give it away
 *
 * wpGraphicStudio is distributed in the hope that it will be useful,
...
final class wp_Graphic_Studio {
	...
	private function includes() {
		...
		require_once WPGS_PLUGIN_DIR . 'includes/class.upload.php';
